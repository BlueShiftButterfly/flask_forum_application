...
from application.user import UsernameValidator, PasswordValidator, UsernameValidationResult, PasswordValidationResult, User, UserCredentialsData
from application.db import DatabaseBridge
from application.cryptography import check_password, hash_password

class Authenticator:
    def __init__(self, db: DatabaseBridge, username_validator: UsernameValidator, password_validator: PasswordValidator) -> None:
        self.db = db
    ...
    def signup(self, username, password):
        un_result = self.username_validator.validate(username, self.db.get_usernames())
